...
const fieldClassName =
  "w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100 disabled:cursor-not-allowed disabled:opacity-60";
  ...
  return (
    ...
    >
        ...
        <div>
          <div className="mb-2 flex items-center justify-between gap-4">
            ...
            <span className="text-sm font-semibold">
              {tc("ratingOf", { rating: confidenceLevel })}
            </span>
          </div>
          <input
            id="confidence"
      ...
      <button
        ...
        className="w-full rounded-xl bg-gradient-to-r from-indigo-500 to-violet-600 px-4 py-2.5 text-sm font-medium text-white shadow-md disabled:pointer-events-none disabled:opacity-60"
      >
